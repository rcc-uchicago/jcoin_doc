...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["JCOIN Dashboard Guide","1. Dashboard Diagram","1.1. Dashboard Layout","1.2. Funding Dashboard","1.3. Grant Distribution by Funder Chart","1.2.1. Section 1. Filtering on State and/or City","1.2.2. Section 2. Filtering on Funder","1.3.1. Section 1. Filtering on Funder","1.3.2. Section 1. Filtering on State","1.3.3. Section 2. Filtering on State and Funder  Action"],
    DREX_NODE_LINKS: ["index.html","dashboard_diagram.html","dashboard_layout.html","funding_dashboard.html","grant_distribution_by_funder_chart.html","section_1__filtering_on_state_and_or_city.html","section_2__filtering_on_funder.html","section_1__filtering_on_funder.html","section_1__filtering_on_state.html","section_2__filtering_on_state_and_funder__action.html"],
    DREX_NODE_CHILD_START: [1,2,5,5,7,10,10,10,10,10],
    DREX_NODE_CHILD_END: [2,5,5,7,10,10,10,10,10,10],
    DREX_MENU_TYPE: 0,
